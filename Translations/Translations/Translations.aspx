...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="five_sixth sidebar_right" id="divTranslators" runat="server">
        <aside>
            <div id="divTranslations" runat="server" style="float: left; margin: 1px 3px 1px 1px; width: 98.5%;">
                      ...
                      <RowStyle CssClass="DataRow" />
                       ...
                       <PagerStyle HorizontalAlign="Right" BackColor="White" ForeColor="Black"></PagerStyle>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Translated" HeaderText="Translated" DataFormatString="{0:d}" />
                           ...
                           <%-- <asp:BoundField DataField="Created" HeaderText="Created" DataFormatString="{0:d}" />--%>
                            <asp:TemplateField HeaderText="Edit">
                                ...
                                <ItemTemplate>
                                    ...
                                    <%--<a href='translations2.aspx?ID=<%#Eval("Id").ToString() %>' class="btn btn-primary" target="_self">UPDATE </a>--%>
